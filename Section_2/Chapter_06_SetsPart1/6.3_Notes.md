...
3 Questions
If you have a set fruits = {'apple', 'banana', 'cherry'} and you want to remove 'grape' without raising an error, which method should you use?
1. Wrong Answer
remove()
...
After calling clear() on a set, what will be the result if you print the set?
1. Correct Answer
set()
