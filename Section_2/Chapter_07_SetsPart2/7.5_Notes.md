...
1 Question
When iterating over a set of integers {10, 20, 30, 40, 50}, which statement is true?

1. Correct Answer 
The order of printed numbers may vary between different executions

2. Wrong Answer
The numbers will always be printed in ascending order

3. Wrong Answer
The numbers will be printed in the order they were added to the set

4. Wrong Answer
The numbers will always be printed in descending order
